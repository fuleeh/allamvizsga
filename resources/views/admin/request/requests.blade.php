...
<div class="col-sm-9">
    ...
    <div class="col-sm-6">
        ...
        {!! Form::open(['method'=>'POST', 'action'=>'AdminRequestsController@createRequest']) !!}
        ...
        <div class="form-group">
            {!! Form::label('freq_start', 'Frequency startt:') !!}
        ...
        @if($fields)
            ...
            <input value="{{$field->id}}" class="form-check-input" type="checkbox" name="field[]" id="field-{{$k}}">
